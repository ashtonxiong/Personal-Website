...
export { default as StyledEngineProvider } from '@mui/styled-engine-sc/StyledEngineProvider';

export { default as GlobalStyles } from '@mui/styled-engine-sc/GlobalStyles';
export * from '@mui/styled-engine-sc/GlobalStyles';
